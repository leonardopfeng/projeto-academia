...
public class TrainingSessionController {
    ...
    @CrossOrigin(origins = "http://localhost:8080")
    @GetMapping(
            value = "/findAllByCoachId/{coachId}",
            produces = {
                    br.com.lelis.util.MediaType.APPLICATION_JSON,
                    br.com.lelis.util.MediaType.APPLICATION_XML,
                    br.com.lelis.util.MediaType.APPLICATION_YML
    ...
    @Operation(
            summary = "Finds all Training Sessions by Coach Id",
            description = "Finds all Training Sessions by Coach Id",
            tags = {"Training Sessions"},
            responses = {
                    @ApiResponse(description = "Success", responseCode = "200",
                            content = {
    ...
    public ResponseEntity<PagedModel<EntityModel<TrainingSessionVO>>> findAllByCoachId(
        ...
        // The number of the page; How many elements it has; How it'll be ordered
        Pageable pageable = PageRequest.of(page, size, Sort.by(sortDirection, "name"));
        return ResponseEntity.ok(service.findAllByCoachId(coachId ,pageable));
    }
